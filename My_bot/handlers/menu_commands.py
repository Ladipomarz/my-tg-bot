...
async def setup_bot_profile(tg_app):
    ...
    try:
        ...
        await tg_app.bot.set_my_name(name="Explosive Rush ☠") 
        await tg_app.bot.set_my_description(description="🤖 Welcome! to the Explosive Rush Box,🔨 We provide you with premium services,💯 Anonimity😎 Fully Crypto Based💪 \n\nClick Start below to begin.🌍")
...
async def help_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    import asyncio
    from utils.auto_delete import delete_tracked_message, safe_delete_user_message, safe_send
    from telegram import InlineKeyboardMarkup, InlineKeyboardButton
    from config import SUPPORT_HANDLE
